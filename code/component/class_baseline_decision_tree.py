...
class DecisionTree:
    ...
    def __init__(self, df, target, test_size, random_state, k_folds, criterion, max_depth, min_samples_leaf):   # usually criterion = 'gini' or 'entropy', max_depth=3, min_samples_leaf=5
        self.df = df
        self.target = target
