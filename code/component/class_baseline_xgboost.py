...
class XGB:
    ...
    def __init__(self, df, target, test_size, random_state, k_folds, n_estimators, eta):     # n_estimators defaul = 100; eta defaul = 0.3 (to get L shape increase n; to avoid long-tail, decrease eta)
        self.df = df
        self.target = target
        ...
        # get y_pred
        self.model = XGBClassifier(n_estimators = n_estimators, eta=eta)
